...
public abstract class EntityLiving extends Entity {
   ...
   public EntityLiving(World p_i3443_1_) {
      ...
      for(int var2 = 0; var2 < this.field_82174_bp.length; ++var2) {
         this.field_82174_bp[var2] = 0.05F;
      }
   ...
   public void func_70645_a(DamageSource p_70645_1_) {
      ...
      if(!this.field_70170_p.field_72995_K) {
         ...
         if(!this.func_70631_g_() && this.field_70170_p.func_82736_K().func_82766_b("doMobLoot")) {
            ...
            this.func_82160_b(this.field_70718_bc > 0, var3);
            if(this.field_70718_bc > 0) {
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      this.field_82172_bs = p_70037_1_.func_74767_n("CanPickUpLoot");
   ...
   public void func_70636_d() {
      ...
      if(!this.field_70170_p.field_72995_K && this.field_82172_bs && !this.field_70729_aU && this.field_70170_p.func_82736_K().func_82766_b("mobGriefing")) {
   ...
   protected void func_70679_bo() {
      ...
      if(this.field_70752_e) {
         if(!this.field_70170_p.field_72995_K) {
            if(this.field_70713_bf.isEmpty()) {
               ...
               this.field_70180_af.func_75692_b(8, Integer.valueOf(var11));
      ...
      var11 = this.field_70180_af.func_75679_c(8);
      boolean var12 = this.field_70180_af.func_75683_a(9) > 0;
      if(var11 > 0) {
         boolean var4 = false;
