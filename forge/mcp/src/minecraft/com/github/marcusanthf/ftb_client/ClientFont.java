...
public class ClientFont {
	...
	public ClientFont(Minecraft var1, Font var2) {
		this(var1, var2, 32, 126);
	}

	public ClientFont(Minecraft var1, Font var2, int var3, int var4) {
		this.startChar = var3;
		this.endChar = var4;
		...
		var6.setRenderingHint(RenderingHints.KEY_TEXT_ANTIALIASING,
		...
		for (int var10 = var3; var10 < var4; ++var10) {
			var6.drawString(String.valueOf((char) var10), var8, var9
					+ this.metrics.getAscent());
			...
			if (var8 >= 250 - this.metrics.getMaxAdvance()) {
				var8 = 2;
				var9 += this.metrics.getMaxAscent()
						+ this.metrics.getMaxDescent() + var7 / 2;
			}
		}
	...
	public final void renderString(String var2, int var3, int var4, int var5) {

		// GL11.glMatrixMode(GL11.GL_PROJECTION);
		// GL11.glOrtho(0D, mc.displayWidth, mc.displayHeight, 0D, 0D, 100D);
		...
		if (var2 != null) {
			...
			for (int var12 = 0; var12 < var11; ++var12) {
				...
				if (var13 == 167 && var12 + 1 < var2.length()) {
					...
					int var15 = "0123456789abcdefklmnor".indexOf(var2
							.toLowerCase().charAt(var12 + 1));

					if (var15 < 16) {
						try {
							int var16 = mc.fontRenderer.getColorCode()[var15];
							GL11.glColor3f((float) (var16 >> 16) / 255.0F,
									(float) (var16 >> 8 & 255) / 255.0F,
									(float) (var16 & 255) / 255.0F);
					...
					try {
						this.drawChar(new Gui(), var13, var3, var4);
						var3 = (int) ((double) var3 + this.metrics
								.getStringBounds(Character.toString(var13),
										(Graphics) null).getWidth());
	...
	public void drawStringWithShadow(Gui var1, String var2, int var3, int var4,
			int var5) {
		var3 /= 2;
		var4 += 2;
		GL11.glEnable(GL11.GL_BLEND);
		this.drawStringWithOutColor(var1, var2, var3, var4 + 1, 0xff000000);
		this.renderString(var2, var3, var4, var5);
		GL11.glDisable(GL11.GL_BLEND);
	}

	public void drawString(Gui var1, String var2, int var3, int var4, int var5) {
		var3 /= 2;
		var4 += 2;
		GL11.glEnable(GL11.GL_BLEND);
		this.renderString(var2, var3, var4, var5);
	...
	public final void drawStringWithOutColor(Gui var1, String var2, int var3,
			int var4, int var5) {
		if (var2 != null) {
			var3 *= 4;
			var4 = var4 * 2 - 7;
				...
				if (var13 == 167 && var12 + 1 < var2.length()) {
					...
					if (var15 < 16) {
						try {
							int var16 = mc.fontRenderer.getColorCode()[var15];
							// GL11.glColor3f((float)(var16 >> 16) / 255.0F,
							// (float)(var16 >> 8 & 255) / 255.0F, (float)(var16
							// & 255) / 255.0F);
						} catch (Exception var17) {
							var17.printStackTrace();
						}
	...
	private final void drawChar(Gui var1, char var2, int var3, int var4)
			throws ArrayIndexOutOfBoundsException {
		Rectangle2D var5 = this.metrics.getStringBounds(
				Character.toString(var2), this.graphics);
		var1.drawTexturedModalRect(var3, var4, this.xPos[(byte) var2
				- this.startChar], this.yPos[(byte) var2 - this.startChar],
				(int) var5.getWidth(),
				(int) var5.getHeight() + this.metrics.getMaxDescent());
	}
