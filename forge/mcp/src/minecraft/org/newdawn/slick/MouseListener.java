...
public interface MouseListener extends ControlledInputReciever {
	 ...
	 * handling the single click may be delayed slightly. For absolute
	 * notification of single clicks use mousePressed().
	 * 
	 * To be absolute this method should only be used when considering double
	 * clicks
	 * 
	 * @param button
