...
/**
 * A sound implementation wrapped round a player which reads (and potentially)
 * rereads a stream. This supplies streaming audio
 * 
 * @author kevin
...
public class StreamSound extends AudioImpl {
	...
	private void cleanUpSource() {
		...
		int queued = AL10.alGetSourcei(store.getSource(0),
