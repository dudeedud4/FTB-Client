...
/**
 * A single state building up part of the game. The state include rendering,
 * logic and input handling for the state.
 * 
 * @author kevin
 */
public interface GameState extends InputListener {
	 ...
	 *             Indicates a failure to initialise a resource for this state
	 */
	 ...
	 * @throws SlickException
	 *             Indicates a failure to render an artifact
	 */
