...
/**
 * A transition that moves to the next as though it was selected by some
 * background menu. Note this transition is provided as an example more than
 * intended for use. The values contained are designed for 800x600 resolution.
 * 
...
public class SelectTransition implements Transition {
	...
	public void postRender(StateBasedGame game, GameContainer container,
		...
		if (!moveBackDone) {
			...
			g.setClip((int) xp1, (int) yp1,
					(int) (scale1 * container.getWidth()),
					(int) (scale1 * container.getHeight()));
	...
	public void preRender(StateBasedGame game, GameContainer container,
		...
		g.setClip((int) xp2, (int) yp2, (int) (scale2 * container.getWidth()),
