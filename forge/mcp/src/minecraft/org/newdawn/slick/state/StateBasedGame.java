...
/**
 * A state based game isolated different stages of the game (menu, ingame,
 * hiscores, etc) into different states so they can be easily managed and
 * maintained.
 * 
 * @author kevin
 */
public abstract class StateBasedGame implements Game, InputListener {
	...
	/**
	 * Add a state to the game. The state will be updated and maintained by the
	 * game
	 * 
	 * @param state
	 ...
	 * @return The state requested or null if no state with the specified ID
	 *         exists
	 */
	...
	public void enterState(int id, Transition leave, Transition enter) {
		...
		if (nextState == null) {
			throw new RuntimeException("No game state registered with the ID: "
					+ id);
		}
	 ...
	 * @throws SlickException
	 *             Indicates a failure to initialise the state based game
	 *             resources
	 */
	...
	/**
	 * User hook for rendering at the before the current state and/or transition
	 * have been rendered
	 * 
	 * @param container
	 ...
	 * @throws SlickException
	 *             Indicates a failure within render
	 */
	...
	/**
	 * User hook for rendering at the game level after the current state and/or
	 * transition have been rendered
	 * 
	 * @param container
	 *            The container in which the game is hosted
	 * @param g
	...
	/**
	 * User hook for updating at the game before the current state and/or
	 * transition have been updated
	 * 
	 * @param container
	 *            The container in which the game is hosted
	 * @param delta
