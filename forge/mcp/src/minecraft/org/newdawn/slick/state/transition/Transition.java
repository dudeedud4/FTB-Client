...
public interface Transition {
	 ...
	 *             Indicates a failure occured during the update
	 */
	 ...
	 * @throws SlickException
	 *             Indicates a failure occured during the render
	 */
	 ...
	 * 
	 * @param firstState
	 *            The first state we're rendering (this will be rendered by the
	 *            framework)
	 * @param secondState
	 *            The second stat we're transitioning to or from (this one won't
	 *            be rendered)
	 */
