...
/**
 * A utility to allow game setup/state to be stored locally. This utility will
 * adapt to the current enviornment (webstart or file based). Note that this
 * will not currently work in an applet.
 * 
 * @author kappaOne
 */
public class SavedState {
	...
	/**
	 * Create and Test to see if the app is running as webstart or local app and
	 * select the appropriate muffin type
	 * 
	 * @param fileName
	 *            name of muffin where data will be saved
	 * @throws SlickException
	 *             Indicates a failure to load the stored state
	 */
	...
	/**
	 * Save the given value at the given location will overwrite any previous
	 * value at this location
	 * 
	 * @param nameOfField
	 *            The name to store the value against
	 * @param value
	 *            The value to store
	 */
	 ...
	 * 
	 * @throws IOException
	 *             Indicates it wasn't possible to store the state
	 */
	 ...
	 * 
	 * @throws IOException
	 *             Indicates it wasn't possible to load the state
	 */
