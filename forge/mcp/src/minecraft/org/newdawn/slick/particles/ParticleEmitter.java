...
/**
 * An emitter is responsible for producing the particles and controlling them
 * during their life. An implementation of this interface can be considered a
 * particle effect.
 * 
 * @author kevin
 */
public interface ParticleEmitter {
	/**
	 * Update the emitter, produce any particles required by requesting them
	 * from the particle system provided.
	 * 
	 * @param system
	 *            The particle system used to create particles
	 * @param delta
	 *            The amount of time in milliseconds since last emitter update
	 */
	...
	/**
	 * Wrap up the particle emitter. This means the emitter will no longer
	 * produce particles and will be marked as completed once the particles have
	 * expired
	 */
	public void wrapUp();
	 ...
	 * @param delta
	 *            The amount of time in millisecond since last particle update
	 */
	 ...
	 * 
	 * @param enabled
	 *            True if the emitter should be enabled
	 */
	...
	/**
	 * Check if this emitter should use points based on it's own settings and
	 * those of the particle system
	 * 
	 * @param system
