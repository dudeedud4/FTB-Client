...
/**
 * A utility wrapper round the standard DOM XML element. This provides a more
 * simple API for accessing attributes, children and providing defaults when
 * schemas arn't used - which is generally a little simpler for most of us.
 * 
 * @author kevin
 */
public class XMLElement {
	 ...
	 *            The name of the attribute whose value should be retrieved
	 * @param def
	 *            The default value to return if the attribute is specified
	 * @return The value given for the attribute
	 */
	...
	/**
	 * Get the value specified for a given attribute on this element as an
	 * integer.
	 * 
	 * @param name
	 *            The name of the attribute whose value should be retrieved
	 ...
	 *             Indicates a failure to convert the value into an integer
	 */
	public int getIntAttribute(String name) throws SlickXMLException {
		try {
			return Integer.parseInt(getAttribute(name));
		} catch (NumberFormatException e) {
			throw new SlickXMLException("Value read: '" + getAttribute(name)
					+ "' is not an integer", e);
		}
	}
	...
	public int getIntAttribute(String name, int def) throws SlickXMLException {
		try {
			...
			throw new SlickXMLException("Value read: '"
					+ getAttribute(name, "" + def) + "' is not an integer", e);
		}
	}
	 ...
	 * @return The value given for the attribute
	 * @throws SlickXMLException
	 *             Indicates a failure to convert the value into an double
	 */
	...
	public double getDoubleAttribute(String name, double def)
		...
		try {
			...
			throw new SlickXMLException("Value read: '"
					+ getAttribute(name, "" + def) + "' is not a double", e);
		}
	}

	/**
	 * Get the value specified for a given attribute on this element as a
	 * boolean.
	 * 
	 * @param name
	 *            The name of the attribute whose value should be retrieved
	 * @return The value given for the attribute
	 * @throws SlickXMLException
	 *             Indicates a failure to convert the value into an boolean
	 */
	...
	public boolean getBooleanAttribute(String name, boolean def)
		...
		throw new SlickXMLException("Value read: '"
				+ getAttribute(name, "" + def) + "' is not a boolean");
	}
	 ...
	 * 
	 * @param name
	 *            The name of the element type that should be retrieved
