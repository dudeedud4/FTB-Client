...
public class Util {
	...
	static NonGeometricData getNonGeometricData(Element element) {
		...
		data.addAttribute(NonGeometricData.FILL,
				getStyle(element, NonGeometricData.FILL));
		data.addAttribute(NonGeometricData.STROKE,
				getStyle(element, NonGeometricData.STROKE));
		data.addAttribute(NonGeometricData.OPACITY,
				getStyle(element, NonGeometricData.OPACITY));
		data.addAttribute(NonGeometricData.STROKE_DASHARRAY,
				getStyle(element, NonGeometricData.STROKE_DASHARRAY));
		data.addAttribute(NonGeometricData.STROKE_DASHOFFSET,
				getStyle(element, NonGeometricData.STROKE_DASHOFFSET));
		data.addAttribute(NonGeometricData.STROKE_MITERLIMIT,
				getStyle(element, NonGeometricData.STROKE_MITERLIMIT));
		data.addAttribute(NonGeometricData.STROKE_OPACITY,
				getStyle(element, NonGeometricData.STROKE_OPACITY));
		data.addAttribute(NonGeometricData.STROKE_WIDTH,
				getStyle(element, NonGeometricData.STROKE_WIDTH));

		return data;
	}

	/**
	 * Get the meta data store within an element either in the label or id
	 * atributes
	 * 
	 * @param element
	 *            The element to be processed
	...
	/**
	 * Get the style attribute setting for a given style information element
	 * (i.e. fill, stroke)
	 * 
	 * @param element
	 *            The element to be processed
	 ...
	 * 
	 * @param style
	 *            The style string to be decoded
	 * @param attribute
	 ...
	 * 
	 * @param element
	 *            The element from which the transform should be read
	 ...
	 *            The element from which the transform should be read
	 * @param attribute
	 *            The name of the attribute holding the transform
	 * @return The transform to be applied
	 */
	 ...
	 * 
	 * @param element
	 *            The element from which the attribute should be read
	 * @param attr
	 *            The attribute to be read
	 * @return The value from the given attribute
	 * @throws ParsingException
	 *             Indicates the value in the attribute was not a float
	 */
	 ...
	 * 
	 * @param value
	 *            The value to treat as reference
