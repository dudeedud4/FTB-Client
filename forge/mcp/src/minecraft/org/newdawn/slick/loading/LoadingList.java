...
public class LoadingList {
	...
	/**
	 * Indicate if we're going to use deferred loading. (Also clears the current
	 * list)
	 * 
	 * @param loading
	...
	/**
	 * The total number of elements that have been added - does not go down as
	...
	public void remove(DeferredResource resource) {
		Log.info("Early loading of deferred resource due to req: "
