...
/**
 * A fill effect used to define gradients when filling and drawing shapes. A
 * gradient is defined by two control points. Each point that is rendered is
 * coloured based on it's proximity to the points. Note that the points are
 * defined relative to the center of the shape being drawn. This is with the
 * intention that the gradient fills can be used and do not need to be updated
...
public class GradientFill implements ShapeFill {
	 ...
	 * 
	 * @param sx
	 *            The x coordinate of the starting control point
	 * @param sy
	 *            The y coordinate of the starting control point
	 * @param startCol
	 *            The colour to apply at the starting control point
	 * @param ex
	 *            The x coordinate of the ending control point
	 * @param ey
	 *            The y coordinate of the ending control point
	 * @param endCol
	 *            The colour to apply at the ending control point
	 */
	public GradientFill(float sx, float sy, Color startCol, float ex, float ey,
			Color endCol) {
	 ...
	 *            The colour to apply at the ending control point
	 * @param local
	 *            True if the gradient is defined in local shape coordinates
	 */
	public GradientFill(float sx, float sy, Color startCol, float ex, float ey,
			Color endCol, boolean local) {
	 ...
	 * 
	 * @param start
	 *            The position of the starting control point
	 * @param startCol
	 *            The colour to apply at the starting control point
	 * @param end
	 *            The position of the ending control point
	 * @param endCol
	 *            The colour to apply at the ending control point
	 * @param local
	 *            True if the gradient is defined in local shape coordinates
	 */
	public GradientFill(Vector2f start, Color startCol, Vector2f end,
			Color endCol, boolean local) {
	 ...
	 * 
	 * @param local
	 *            True if the gradient is defined in shape local coordinates
	 */
	 ...
	 * 
	 * @param start
	 *            The new poisition for the start point
	 */
	 ...
	 * 
	 * @param end
	 *            The new position for the end point
	 */
	 ...
	 * 
	 * @param color
	 *            The colour to apply at the start control point
	 */
	 ...
	 * 
	 * @param color
	 *            The colour to apply at the end control point
	 */
	 ...
	 * @return The colour that should be applied based on the control points of
	 *         this gradient
	 */
	...
	/**
	 * @see org.newdawn.slick.ShapeFill#getOffsetAt(org.newdawn.slick.geom.Shape,
	 *      float, float)
	 */
