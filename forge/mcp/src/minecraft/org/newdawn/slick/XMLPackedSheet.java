...
/**
 * A sprite sheet based on an XML descriptor generated from the simple slick
 * tool
 * 
 * @author kevin
 */
public class XMLPackedSheet {
	 ...
	 *             Indicates a failure to parse the XML or read the image
	 */
	public XMLPackedSheet(String imageRef, String xmlRef) throws SlickException {
		...
		try {
			DocumentBuilder builder = DocumentBuilderFactory.newInstance()
					.newDocumentBuilder();
			Document doc = builder.parse(ResourceLoader
					.getResourceAsStream(xmlRef));
	 ...
	 * @return The sprite from the sheet or null if the name isn't used in this
	 *         sheet
	 */
