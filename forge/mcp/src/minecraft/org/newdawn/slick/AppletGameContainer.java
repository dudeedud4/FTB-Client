...
public class AppletGameContainer extends Applet {
	...
	public void init() {
		...
		try {
			Game game = (Game) Class.forName(getParameter("game"))
					.newInstance();
	...
	public class ContainerPanel {
		...
		public void start() throws Exception {
			...
			try {
				...
				e.printStackTrace();
				// failed to create Display, apply workaround (sleep for 1
	...
	public class Container extends GameContainer {
		 ...
		 * 
		 * @throws Exception
		 *             Indicates a failure within the game's loop rather than
		 *             the framework
		 */
	...
	/**
	 * A basic console to display an error message if the applet crashes. This
	 * will prevent the applet from just freezing in the browser and give the
	 * end user an a nice gui where the error message can easily be viewed and
	 * copied.
	 */
	public class ConsolePanel extends Panel {
		 ...
		 * 
		 * @param e
		 *            The exception causing the console to be displayed
		 */
