...
/**
 * A test for deferred loading. Each of the resources is requested then the
 * loading list is cycled to actual perform the resource allowing the rendering
