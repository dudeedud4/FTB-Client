...
public class SavedStateTest extends BasicGame implements ComponentListener {
	...
	public void init(GameContainer container) throws SlickException {
		...
		name = new TextField(container, container.getDefaultFont(), 100, 100,
				300, 20, this);
		age = new TextField(container, container.getDefaultFont(), 100, 150,
				201, 20, this);
	}
	...
	public void render(GameContainer container, Graphics g) {
		...
		container.getDefaultFont().drawString(100, 300,
				"Stored Name: " + nameValue);
		container.getDefaultFont().drawString(100, 350,
				"Stored Age: " + ageValue);
