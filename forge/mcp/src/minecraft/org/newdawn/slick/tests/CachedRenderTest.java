...
/**
 * A simple test to show performance gains from cache operations in situtations
 * where rendering is static and heavy
 * 
 * @author kevin
 */
		...
		operations = new Runnable() {
			public void run() {
				for (int i = 0; i < 100; i++) {
					...
					container.getGraphics().drawOval((i * 5) + 50,
							(i * 3) + 50, 100, 100);
				}
			}
		};
