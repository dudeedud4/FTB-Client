...
public class GUITest extends BasicGame implements ComponentListener {
	...
	public void init(GameContainer container) throws SlickException {
		...
		field = new TextField(container, font, 150, 20, 500, 35,
		...
		field2 = new TextField(container, font, 150, 70, 500, 35,
				new ComponentListener() {
					public void componentActivated(AbstractComponent source) {
		...
		for (int i = 0; i < 4; i++) {
			areas[i] = new MouseOverArea(container, image, 300,
					100 + (i * 100), 200, 90, this);
