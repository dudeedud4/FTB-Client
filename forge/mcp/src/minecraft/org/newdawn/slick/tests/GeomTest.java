...
public class GeomTest extends BasicGame {
	...
	private Shape rect1 = new Rectangle(150, 120, 50, 100).transform(Transform
			.createTranslateTransform(50, 50));
	/** The rectangle tested */
	private Shape rect2 = new Rectangle(310, 210, 50, 100).transform(Transform
			.createRotateTransform((float) Math.toRadians(45), 335, 260));
	/** The circle tested */
	...
	/** The circle tested */
	private Shape circle4 = new Ellipse(510, 350, 30, 30)
			.transform(Transform.createTranslateTransform(-510, -350))
			.transform(Transform.createScaleTransform(2, 2))
			.transform(Transform.createTranslateTransform(510, 350));
	...
	private Shape roundRect2 = new RoundedRectangle(50, 280, 50, 50, 20, 20,
			RoundedRectangle.TOP_LEFT | RoundedRectangle.BOTTOM_RIGHT);
	...
	public void render(GameContainer container, Graphics g) {
		...
		g.drawString("Red indicates a collision, green indicates no collision",
				50, 420);
