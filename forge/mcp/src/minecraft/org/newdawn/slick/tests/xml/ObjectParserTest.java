...
/**
 * A simple test to check that the object parser from XML works. Read the
 * Javadoc of ObjectParser to work out whats going on here
 * 
 * @author kevin
 */
public class ObjectParserTest {
	...
	/**
	 * Entity point to our test. Simple read some XML which should generate an
	 * object tree.
	 * 
	 * @param argv
	...
	public static void main(String[] argv) throws SlickXMLException {
		...
		GameData parsedData = (GameData) parser
				.parse("testdata/objxmltest.xml");
		parsedData.dump("");
	}
}
