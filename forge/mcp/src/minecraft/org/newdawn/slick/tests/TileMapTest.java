...
public class TileMapTest extends BasicGame {
	...
	public void render(GameContainer container, Graphics g) {
		...
		g.drawString("non existing map property: " + nonExistingMapProperty,
				10, 525);
		g.drawString(
				"non existing layer property: " + nonExistingLayerProperty, 10,
				575);
	}
