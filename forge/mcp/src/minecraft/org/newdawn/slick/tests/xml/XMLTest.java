...
public class XMLTest {
	 ...
	 * 
	 * @param argv
	 *            The arguments given to the test
	...
	public static void main(String[] argv) throws SlickException {
		...
		System.out
				.println(root.getChildrenByName("simple").get(0).getContent());
		...
		assertEquals(parent.getChildrenByName("child").get(0).getChildren()
				.size(), 2);
		XMLElement child = parent.getChildrenByName("child").get(0)
				.getChildren().get(0);
