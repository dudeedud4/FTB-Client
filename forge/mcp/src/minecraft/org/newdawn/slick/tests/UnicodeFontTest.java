...
public class UnicodeFontTest extends BasicGame {
	...
	public void init(GameContainer container) throws SlickException {
		...
		// unicodeFont = new UnicodeFont(Font.decode("Arial Unicode MS"), 25,
		// false, false);
		...
		// unicodeFont.getEffects().add(new ShadowEffect(java.awt.Color.black,
		// 5, 5, 0.5f));
	...
	public void render(GameContainer container, Graphics g) {
		...
		g.drawRect(10, 33, unicodeFont.getWidth(text),
				unicodeFont.getLineHeight());
		g.setColor(Color.blue);
		int yOffset = unicodeFont.getYOffset(text);
		g.drawRect(10, 33 + yOffset, unicodeFont.getWidth(text),
				unicodeFont.getHeight(text) - yOffset);

		// font.drawString(10, 73,
		// "\u6880\u6881\u6882 (...) \u6883\u6884\u6885\u6886\u6887 hi?");

		unicodeFont.addGlyphs("~!@!#!#$%___--");
		// Cypriot Syllabary glyphs (Everson Mono font):
		// \uD802\uDC02\uD802\uDC03\uD802\uDC12 == 0x10802, 0x10803, s0x10812
		// g.drawLine(0, container.getHeight() - 512, container.getWidth(),
		// container.getHeight() - 512);
	}
