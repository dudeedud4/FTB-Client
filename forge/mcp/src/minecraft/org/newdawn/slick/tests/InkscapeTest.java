...
public class InkscapeTest extends BasicGame {
	...
	public void init(GameContainer container) throws SlickException {
		...
		// renderer[0] = new
		// SimpleDiagramRenderer(InkscapeLoader.load("testdata/svg/orc.svg"));
		// renderer[1] = new
		// SimpleDiagramRenderer(InkscapeLoader.load("testdata/svg/head2.svg"));
		// renderer[2] = new
		// SimpleDiagramRenderer(InkscapeLoader.load("testdata/svg/head3.svg"));
		renderer[3] = new SimpleDiagramRenderer(
				InkscapeLoader.load("testdata/svg/clonetest.svg"));
		// renderer[4] = new
		// SimpleDiagramRenderer(InkscapeLoader.load("testdata/svg/cow.svg"));
