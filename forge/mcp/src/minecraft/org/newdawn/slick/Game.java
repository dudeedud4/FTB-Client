...
/**
 * The main game interface that should be implemented by any game being
 * developed using the container system. There will be some utility type
 * sub-classes as development continues.
 * 
