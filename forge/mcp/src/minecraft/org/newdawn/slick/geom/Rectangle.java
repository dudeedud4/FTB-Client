...
public class Rectangle extends Shape {
	 ...
	 * 
	 * @param other
	 *            The other rectangle whose bounds should be applied
	 */
	public void setBounds(Rectangle other) {
		setBounds(other.getX(), other.getY(), other.getWidth(),
				other.getHeight());
	}
	 ...
	 * @param width
	 *            The width to set in this rectangle
	 * @param height
	...
	/**
	 * Grow the rectangle at all edges by the given amounts. This will result in
	 * the rectangle getting larger around it's centre.
	 * 
	 * @param h
	 *            The amount to adjust horizontally
	 * @param v
	 *            The amount to ajust vertically
	 */
	 ...
	 * 
	 * @param h
	 *            The scale to apply to the horizontal
	 * @param v
	 *            The scale to appy to the vertical
	 */
	...
	protected void createPoints() {
		// -1 so that the dimensions include the left and top lines of the
		// rectangle
