...
/**
 * The description of any 2D shape that can be transformed. The points provided
 * approximate the intent of the shape.
 * 
 * @author Mark
 */
public abstract class Shape implements Serializable {
	 ...
	 * @return The index of the point or -1 if the point is not part of this
	 *         shape path
	 */
