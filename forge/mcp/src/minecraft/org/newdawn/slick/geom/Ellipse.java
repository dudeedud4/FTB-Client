...
/**
 * An ellipse meeting the <code>Shape</code> contract. The ellipse is actually
 * an approximation using a series of points generated around the contour of the
 * ellipse.
 * 
 * @author Mark
 */
public class Ellipse extends Shape {
	...
	public Ellipse(float centerPointX, float centerPointY, float radius1,
			float radius2) {
		this(centerPointX, centerPointY, radius1, radius2,
