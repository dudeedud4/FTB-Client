...
/**
 * A beizer curve implementation. The curve is defined by a start point, an end
 * point and two control points that it will tend towards. This is
 * implementation is fixed segmenting meaning it doesn't scale too well.
 * 
 * @author kevin
 */
public class Curve extends Shape {
	 ...
	 * 
	 * @param t
	 *            A value between 0 and 1 defining the location of the curve the
	 *            point is at
