...
/**
 * A control describing input provided from a controller. This allows controls
 * to be mapped to game pad inputs.
 * 
 * @author joverton
 */
abstract class ControllerControl implements Control {
	...
	public boolean equals(Object o) {
		...
		return c.controllerNumber == controllerNumber && c.event == event
				&& c.button == button;
	}
