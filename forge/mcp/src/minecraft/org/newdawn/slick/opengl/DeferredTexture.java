...
public class DeferredTexture extends TextureImpl implements DeferredResource {
	 ...
	 */
	public DeferredTexture(InputStream in, String resourceName,
			boolean flipped, int filter, int[] trans) {
		this.in = in;
	...
	public void load() throws IOException {
		...
		target = InternalTextureLoader.get().getTexture(in, resourceName,
				flipped, filter, trans);
