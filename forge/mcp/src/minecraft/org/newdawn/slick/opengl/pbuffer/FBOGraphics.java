...
public class FBOGraphics extends Graphics {
	...
	public FBOGraphics(Image image) throws SlickException {
		...
		if (!FBOEnabled) {
			throw new SlickException(
					"Your OpenGL card does not support FBO and hence can't handle the dynamic images required for this application.");
		}
	...
	private void init() throws SlickException {
		...
		// for some reason FBOs won't work on textures unless you've absolutely
		// just
		// created them.
		try {
	...
	protected void enable() {
		if (!valid) {
			throw new RuntimeException(
					"Attempt to use a destroy()ed offscreen graphics context.");
		}
