...
public class TextureLoader {
	 ...
	 * 
	 * @param format
	 *            The format of the texture to be loaded (something like "PNG"
	 *            or "TGA")
	 * @param in
	 ...
	 */
	public static Texture getTexture(String format, InputStream in,
			boolean flipped) throws IOException {
	...
	public static Texture getTexture(String format, InputStream in,
		...
		return InternalTextureLoader.get().getTexture(in,
				in.toString() + "." + format, flipped, filter);
	}
}
