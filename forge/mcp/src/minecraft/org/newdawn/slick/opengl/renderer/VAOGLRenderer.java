...
/**
 * A renderer that caches all operations into an array, creates an opengl vertex
 * array when required and spits the data down to the card in batch mode
 * 
 * @author kevin
 */
public class VAOGLRenderer extends ImmediateModeOGLRenderer {
	...
	/**
	 * The stack for entering list creation mode - when we're creating a list we
	 * can't use our VAs
	 */
	private int listMode = 0;

	/**
	 * @see org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#initDisplay(int,
	 *      int)
	 */
	...
	/**
	 * @see org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glColor4f(float,
	 *      float, float, float)
	 */
	...
	/**
	 * @see org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glTexCoord2f(float,
	 *      float)
	 */
	...
	/**
	 * @see org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glVertex2f(float,
	 *      float)
	 */
	...
	/**
	 * @see org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glVertex3f(float,
	 *      float, float)
	 */
	...
	/**
	 * @see org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glBindTexture(int,
	 *      int)
	 */
	...
	/**
	 * @see org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glBlendFunc(int,
	 *      int)
	 */
	...
	/**
	 * @see org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glClipPlane(int,
	...
	/**
	 * @see org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glRotatef(float,
	 *      float, float, float)
	 */
	...
	/**
	 * @see org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glScalef(float,
	 *      float, float)
	 */
	...
	/**
	 * @see org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glScissor(int,
	 *      int, int, int)
	 */
	...
	/**
	 * @see org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glTexEnvi(int,
	 *      int, int)
	 */
	...
	/**
	 * @see org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glTranslatef(float,
	 *      float, float)
	 */
	...
	/**
	 * @see org.newdawn.slick.opengl.renderer.ImmediateModeOGLRenderer#glNewList(int,
	 *      int)
	 */
