...
public class TextureImpl implements Texture {
	 ...
	 * 
	 * @param cacheName
	 *            The name the texture is stored against in the cache
	 */
	 ...
	 * 
	 * @param alpha
	 *            True, If this texture has alpha
	 */
	...
	public byte[] getTextureData() {
		ByteBuffer buffer = BufferUtils.createByteBuffer((hasAlpha() ? 4 : 3)
				* texWidth * texHeight);
		bind();
		GL.glGetTexImage(SGL.GL_TEXTURE_2D, 0, hasAlpha() ? SGL.GL_RGBA
				: SGL.GL_RGB, SGL.GL_UNSIGNED_BYTE, buffer);
