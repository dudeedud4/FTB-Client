...
public class PNGImageData implements LoadableImageData {
	...
	/**
	 * Create a new PNG image data that can read image data from PNG formated
	 * files
	 */
	public PNGImageData() {
		this.crc = new CRC32();
	 ...
	 * @throws IOException
	 *             Indicates a failure to read appropriate data from the stream
	 */
	 ...
	 * @param stride
	 *            The image stride to read (i.e. the number of bytes to skip
	 *            each line)
	 * @param flip
	 *            True if the PNG should be flipped
	 * @throws IOException
	 *             Indicates a failure to read the PNG either invalid data or
	 *             not enough room in the buffer
	 */
	private void decode(ByteBuffer buffer, int stride, boolean flip)
			throws IOException {
	...
	/**
	 * Copy some data into the given byte buffer expanding the data based on
	 * indexing the palette
	 * 
	 * @param buffer
	 *            The buffer to write into
	 * @param curLine
	 *            The current line of data to copy
	 */
	...
	/**
	 * Copy the data given directly into the byte buffer (skipping the filter
	 * byte);
	 * 
	 * @param buffer
	 *            The buffer to write into
	 * @param curLine
	 *            The current line to copy into the buffer
	 */
	 ...
	 * 
	 * @param curLine
	 *            The line of data just read
	 * @param prevLine
	 *            The line before
	 * @throws IOException
	 *             Indicates a failure to unfilter the data due to an unknown
	 *             filter type
	 */
	...
	/**
	 * Sub unfilter {@url
	 * http://libpng.nigilist.ru/pub/png/spec/1.2/PNG-Filters.html}
	 * 
	 * @param curLine
	 *            The line of data to be unfiltered
	 */
	 ...
	 * 
	 * @param prevLine
	 *            The line of data read before the current
	 * @param curLine
	 *            The line of data to be unfiltered
	 */
	 ...
	 * 
	 * @throws IOException
	 *             Indicates a failure to read the header
	 */
	 ...
	 * 
	 * @throws IOException
	 *             Indicates a failure to fully read the chunk
	 */
	 ...
	 * 
	 * @throws IOException
	 *             Indicates a failure to read off redundant data
	 */
	 ...
	 * 
	 * @throws IOException
	 *             Indicates a failure to determine chunk information from the
	 *             stream
	 */
	 ...
	 * 
	 * @param expected
	 *            The expected type of the next chunk
	 * @throws IOException
	 *             Indicate a failure to read data or a different chunk on the
	 *             stream
	 */
	 ...
	 * @param offset
	 *            The offset into the buffer to read into
	 * @param length
	 *            The amount of data to read
	 * @return The number of bytes read from the chunk
	 * @throws IOException
	 *             Indicate a failure to read the appropriate data from the
	 *             chunk
	 */
	 ...
	 * 
	 * @param inflater
	 *            The inflater to fill
	 * @throws IOException
	 *             Indicates there is no more data left or invalid data has been
	 *             found on the stream.
	 */
	 ...
	 * 
	 * @param inflater
	 *            The inflater to read the data from
	 * @param buffer
	 *            The buffer to write into
	 * @param offset
	 *            The offset into the buffer at which to start writing
	 * @param length
	 *            The number of bytes to read
	 * @throws IOException
	 *             Indicates a failure to read the complete chunk
	 */
	 ...
	 *            The buffer to read into
	 * @param offset
	 *            The offset to start copying into
	 * @param length
	 *            The length of bytes to read
	 * @throws IOException
	 *             Indicates a failure to access the data
	 */
