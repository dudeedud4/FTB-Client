...
/**
 * A utility to allow performing GL operations without contaminating the Slick
...
public abstract class SlickCallable {
	...
	/**
	 * Enter a safe block ensuring that all the OpenGL state that slick uses is
	...
	/**
	 * Leave a safe block ensuring that all of Slick's OpenGL state is restored
	...
	/**
	 * Cause this callable to perform it's GL operations (@see
	 * performGLOperations()). This method will block until the GL operations
	 * have been performed.
	 * 
	 ...
	 * operations should not effect the slick OpenGL state.
	 * 
	 * @throws SlickException
